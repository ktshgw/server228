...
Готовый фон: [ocean-background-matched.png](../../../client/enhanced-auth/osu.Game.Rulesets.EnhancedAuth/Resources/SomsAi/ocean-background-matched.png). Использован встроенный imagegen в режиме редактирования. Предыдущая иллюстрация сохранена в исходниках; в DLL включена только текущая версия фона.
