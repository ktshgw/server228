...
Использован встроенный imagegen, режим редактирования. Исходная иллюстрация сохранена в репозитории, но исключена из ресурсов DLL. Игра загружает [ocean-background-clear.png](../.sources/LazerAuthlibInjection/osu.Game.Rulesets.EnhancedAuth/Resources/SomsAi/ocean-background-clear.png). Рыбки, арена и подводное оформление сохранены; пузырьки рисуются кодом.
