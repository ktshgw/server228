    ...
    public class SoloScore
    {
        ...
        public SoloScoreInfo ToScoreInfo() => new SoloScoreInfo
        {
            ...
            Statistics = new Dictionary<HitResult, int>
            {
                ...
                { HitResult.LargeTickMiss, (int)(nlarge_tick_miss ?? 0) },
                { HitResult.LargeTickHit, (int)(nlarge_tick_hit ?? 0) },
                { HitResult.SliderTailHit, (int)(nslider_tail_hit ?? 0) },
                { HitResult.SmallTickHit, (int)(nsmall_tick_hit ?? 0) },
            },
