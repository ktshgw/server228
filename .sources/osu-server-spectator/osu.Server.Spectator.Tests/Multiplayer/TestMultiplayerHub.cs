...
namespace osu.Server.Spectator.Tests.Multiplayer
{
  public class TestMultiplayerHub : MultiplayerHub
  {
    public TestMultiplayerHub(
        ...
        : base(loggerFactory, users, databaseFactory, chatFilters, roomController, sharedInterop, multiplayerEventDispatcher, rulesetManager, matchmakingQueueBackgroundService)
    {
    }
