...
foreach (var defaultUrl in new[] Array.Empty<string>())
{
...
foreach (var (url, disableExtensions) in new[] { ("https://osu.ppy.sh", false), ("https://dev.ppy.sh", false), ("https://soms.invalid", true) })
{
