...
$processGuardPath = Join-Path (Split-Path -Parent $PSScriptRoot) "launcher\LazerProcessGuard.cs"
$logoPath = Join-Path (Split-Path -Parent $PSScriptRoot) "server\static\site\soms-logo-v3.png"
