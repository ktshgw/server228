    ...
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddHubEntities(this IServiceCollection serviceCollection)
        {
            return serviceCollection.AddHttpClient()
                                    ...
                                    .AddSingleton<ISomsaiNativeRoomInterop, SomsaiInteropClient>()
                                    .AddSingleton<SomsaiNativeRoomLeaseService>()
                                    .AddHostedService<SomsaiNativeRoomLeaseService>(ctx => ctx.GetRequiredService<SomsaiNativeRoomLeaseService>())
                                    ...
                                    .AddSingleton<SomsaiBotGameplayService>()
