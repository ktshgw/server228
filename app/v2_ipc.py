"""This module implements soms v2 IPC (Inter-Process Communication) for communication between the soms server v2 series.

soms v2 IPC specification:
...
- Redis Pub/Sub channel format: soms:ipc:<server_identifier>. for this server, <server_identifier> is "lazer".
"""
...
class IPCClient:
    """Client for sending IPC messages to soms server v2 series."""
