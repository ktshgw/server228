...
public partial class EnhancedSettingsSubsection(Ruleset ruleset) : RulesetSettingsSubsection(ruleset)
{
    ...
    private FormCheckBox disableServerExtensions = null!;
        ...
        [
            ...
            advancedSettingsFlow = new FillFlowContainer
            {
                ...
                [
                    ...
                    new SettingsItemV2(disableServerExtensions = new FormCheckBox
                    {
                        Caption = "Disable server extensions",
                        HintText = "Disable SOMS-specific client features for an incompatible server.",
                        Current = config.GetBindable<bool>(EnhancedRulesetSettings.DisableServerExtensions),
                    }),
    ...
    private void onSaveChanges()
    {
        ...
        authlibRulesetConfig = new EnhancedRulesetConfig
        {
            ...
            DisableServerExtensions = disableServerExtensions.Current.Value,
        };
