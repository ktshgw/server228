...
try {
    ...
    $catalogue = [ordered]@{
        schema_version = 1
        purpose = 'Local, read-only-source inspection. This export does not publish files; scripts/stage-stable-interface-assets.ps1 selects the explicit optional interface subset.'
