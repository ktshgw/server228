...
try {
  ...
  if(process.argv.includes("--local-assets")){
    ...
    for(const [url,file,type] of [
      ["/site/app.js","server/static/site/app.js","text/javascript"],
      ["/site/styles.css","server/static/site/styles.css","text/css"],
      ["/admin/","server/static/admin/index.html","text/html"],
