...
from app.service.somsai_bot_skill import history_candidates, mod_names, normalize_level, score_sample, skill_profile
...
async def prepare_draft_features(fetcher, redis, match_id: int, ruleset_id: int, slots: list[dict]) -> None:
    ...
    from app.service.somsai_match_service import FINAL_STAGES
