...
class SearchQueryModel(BaseModel):
    ...
    g: Genre = Field(Genre.ANY, description="Genre", alias="g")
    s: Literal[
        "any",
        "leaderboard",
        "ranked",
    ...
    l: Language = Field(Language.ANY, description="Language", alias="l")  # noqa: E741
    sort: Literal[
        "title_asc",
        "artist_asc",
        "difficulty_asc",
    ...
    played: Literal["played", "unplayed"] | None = Field(
        default=None,
        description="Played-state filter; omitted means either",
    )
    nsfw: bool = Field(
        default=False,
